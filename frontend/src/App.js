  ...
  return (
    <div style={{
      ...
      <div style={{ position:'relative', width:'80px', height:'80px' }}>
        ...
        <div style={{ position:'absolute', inset:'16px', borderRadius:'13px', background:'linear-gradient(135deg,#38bdf8,#818cf8)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'16px', animation:'spinPulse 3s ease-in-out infinite' }}>🧠</div>
      </div>
